...
from tools.pallet_utility_test import pallet_utility_batch_test
from tools.pallet_utility_test import pallet_utility_batch_all_test
...
if __name__ == '__main__':
    ...
    pallet_utility_batch_test()
    pallet_utility_batch_all_test()
